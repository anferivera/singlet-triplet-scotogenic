...
%We see that $\sigma(p\,p\to\chi^{\pm}\chi_2^0)\approx 3.5\,\text{fb}$ for $m_{\chi^{\pm}}\approx 800$ GeV which is a typical value of wino-like DM in supersymmetry models with compressed spectra.
